# Generated by Django 5.2.6 on 2025-10-09 03:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity_member', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='cost_items', to='connections.quantitymember')),
            ],
        ),
        migrations.CreateModel(
            name='RawElement',
        ...
        migrations.AddField(
            ...
            name='raw_element',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='quantity_members', to='connections.rawelement'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('name', models.CharField(default='새 공간분류 할당 규칙', max_length=255)),
                ('conditions', models.JSONField(blank=True, default=list, help_text='규칙이 적용될 QuantityMember를 필터링하는 조건')),
                ('priority', models.IntegerField(default=0)),
                ...
                ('target_space', models.ForeignKey(help_text='규칙을 통해 할당될 대상 공간분류', on_delete=django.db.models.deletion.CASCADE, to='connections.spaceclassification')),
            ],
            options={
                'ordering': ['priority', 'name'],
            },
        ...
        migrations.AddField(
            model_name='quantitymember',
            name='space_classifications',
            field=models.ManyToManyField(blank=True, related_name='quantity_members', to='connections.spaceclassification'),
        ),
