# aibim_quantity_takeoff_web/connections/urls.py

from django.urls import path
from . import views

urlpatterns = [
    path('', views.revit_control_panel, name='revit_control_panel'),
    path('create-project/', views.create_project, name='create_project'),
    path('trigger-fetch/<uuid:project_id>/', views.trigger_revit_data_fetch, name='trigger_fetch'),
    
    # 수량산출분류(태그) 가져오기/내보내기 URL
    ...
    # 분류 할당 룰셋 API
    path('api/rules/classification/<str:project_id>/', views.classification_rules_api, name='classification_rules_api'),
    path('api/rules/classification/<str:project_id>/<str:rule_id>/', views.classification_rules_api, name='classification_rule_detail_api'),
    ...
    path('api/cost-items/auto-create/<str:project_id>/', views.create_cost_items_auto_view, name='create_cost_items_auto'),
    path('api/cost-items/<str:project_id>/', views.cost_items_api, name='cost_items_api'),
    path('api/cost-items/<str:project_id>/<str:item_id>/', views.cost_items_api, name='cost_item_detail_api'),
    ...
    path('api/quantity-members/auto-create/<str:project_id>/', views.create_quantity_members_auto_view, name='create_quantity_members_auto'),
    path('api/quantity-members/manage-cost-codes/<str:project_id>/', views.manage_quantity_member_cost_codes_api, name='manage_quantity_member_cost_codes_api'),

    path('api/quantity-members/manage-member-marks/<str:project_id>/', views.manage_quantity_member_member_marks_api, name='manage_quantity_member_member_marks_api'),
    ...
    path('api/quantity-members/<str:project_id>/', views.quantity_members_api, name='quantity_members_api'),
    path('api/boq/grouping-fields/<uuid:project_id>/', views.get_boq_grouping_fields_api, name='get_boq_grouping_fields_api'),
    path('api/quantity-members/<str:project_id>/<str:member_id>/', views.quantity_members_api, name='quantity_member_detail_api'),

    path('api/boq/report/<uuid:project_id>/', views.generate_boq_report_api, name='generate_boq_report_api'),
